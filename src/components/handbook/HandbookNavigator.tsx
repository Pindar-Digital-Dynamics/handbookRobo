...
export default function HandbookNavigator() {
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg p-6 shadow-lg">
       ...
       ${
         currentStep === "subtheme"
           ...
           ? `${selectedSubTheme?.title} > Select Generation`
           : ""
       }`
            : "Select Theme"}
        </h2>
        ...
        <p className="text-slate-600 dark:text-slate-300">
          Placeholder introduction text for {theme.title}. This will be replaced
          with actual content from the API. Lorem ipsum dolor sit amet,
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 relative">
      ...
      <nav
        className="fixed bottom-0 left-0 right-0 h-[30vh] bg-white dark:bg-slate-800 
   ...
   </h3>    <div className="flex items-center justify-between mb-4 px-2">
                  ...
                  {generations.map((generation) => (
                   ...
                   transition-colors"
                    >
                      ...
                      <p className="text-sm">{generation.description}</p>
                    </button>
                  ))}
                </div>
              )}
